...
(function () {
  ...
  const DICT = {
    ...
    'adv.proxyNote': { zh: '本站已代付查詢額度，貼上地址即可查詢。查詢紀錄將用於排行榜。', en: 'Queries are on the house — just paste an address. Results are recorded for the leaderboard.' },
    ...
    'stat.costSub': { zh: '{n} 筆交易掃描', en: '{n} transactions scanned' },
    ...
    'intro.privacy': { zh: '自備 key 時全程在你的瀏覽器執行；用本站額度時查詢經過本站代理，紀錄用於排行榜。圖片僅在本機處理。', en: 'With your own keys everything runs in your browser. Using the site quota, queries go through our proxy and are recorded for the leaderboard. Images never leave your device.' },
